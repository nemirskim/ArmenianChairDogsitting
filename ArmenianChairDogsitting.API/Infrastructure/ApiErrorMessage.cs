...
public class ApiErrorMessage
{
    ...
    public const string WeekDayIsRequired = "Week day was not entered";
    public const string StartTimeIsRequired = "Start time was not entered";
    public const string EndTimeIsRequired = "End time was not entered";
}
